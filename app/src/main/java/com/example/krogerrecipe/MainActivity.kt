...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mRecipeList.add(RecipeData("Perfect Roasted Turkey", "This recipe is a holiday staple!", "DirectionsInstructions Checklist\n" +
                "Step 1\n" +
        ...
        mRecipeList.add(RecipeData("Cast Iron Steaks with Herb Butter", "We chose the moderately expensive boneless strip steak for its big, beefy flavor.", "Sprinkle entire surface of each steak with 1 teaspoon salt. Let sit at room temperature for at least 30 minutes and up to 1 hour.\n" +
                "\n" +
                "2\n" +
        ...
        mRecipeList.add(RecipeData("Hamburgers", "Get Hamburgers Recipe from Food Network","Preheat the oven to 450 degrees F. Place a roasting rack on a foil-lined baking sheet in the oven.\n" +
        ...
        mRecipeList.add(RecipeData("Spaghetti", "Easy Weeknight Spaghetti with Meat Sauce","Check the package directions of the spaghetti you plan to cook. On the box, there should be an approximate cook time for “al-dente,” which means the pasta will be tender, but not mushy. It will still have a bit of a bite, which is perfect.\n" +
